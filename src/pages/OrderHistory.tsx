...
const completedOrders = [
  { id: "ORD-2024-001", customer: "Green Industries Ltd", products: "Biomass Briquettes", qty: "500kg", total: "₹10,000", deliveredOn: "2024-03-10", invoice: "INV-2024-001" },
  { id: "ORD-2023-098", customer: "BioFuel Corp", products: "Wood Pellets", qty: "1500kg", total: "₹27,000", deliveredOn: "2024-03-08", invoice: "INV-2024-002" },
  { id: "ORD-2023-095", customer: "Rural Energy Hub", products: "Groundnut Shell Pellets", qty: "800kg", total: "₹9,600", deliveredOn: "2024-03-05", invoice: "INV-2024-003" },
  { id: "ORD-2023-090", customer: "EcoHeat Solutions", products: "Bagasse Briquettes", qty: "2000kg", total: "₹28,000", deliveredOn: "2024-02-28", invoice: "INV-2024-004" },
  { id: "ORD-2023-085", customer: "Biomass Trading Co", products: "Biomass Briquettes", qty: "3000kg", total: "₹45,000", deliveredOn: "2024-02-20", invoice: "INV-2024-005" },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Completed orders and invoice downloads</p>
      </div>
      ...
      <div className="bg-card rounded-xl border shadow-sm">
        <div className="p-4 border-b">
          <div className="relative w-72">
            ...
            <Input placeholder="Search completed orders..." className="pl-10" value={search} onChange={e => setSearch(e.target.value)} />
          </div>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b bg-muted/50">
                ...
                <th className="text-left px-6 py-3 text-xs font-semibold text-muted-foreground uppercase">Delivered On</th>
            ...
            <tbody>
              {filtered.map((o) => (
                <tr key={o.id} className="border-b last:border-0 hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-muted-foreground">{o.deliveredOn}</td>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={7} className="px-6 py-8 text-center text-muted-foreground">No completed orders found</td></tr>
              )}
            </tbody>
          </table>
        </div>
